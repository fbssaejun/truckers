...
User.create(company_id: 1, name: 'Anthony', role: 'admin', email: 'admin@trucker.com', password_hash: '$2b$12$h0q30TiUGYGhqvnBtm6hdOps3MQhSrOi6C89vyBCcYNqzxkpAoJrm') # 123456
...
Truck.create(company_id: 1, name: 'fancy truck', vehicle_type: 'Dump truck', year: 2021, capacity: 1000, reserved: true)
